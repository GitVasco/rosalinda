...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("TALLERES GENERADOS -".$fecha);
...
$respDetalle = ControladorTalleres::ctrMostrartalleresGenerados($articulo);
$cont = 0;
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" TALLERES GENERADOS - '.$fecha.'.xls"');
