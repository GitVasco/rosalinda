    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <div class="btn-group pull-right" style="margin: 13px;">
          ...
          <button class="btn btn-success  btnFacturados"  title="Ver Pedidos FACTURADOS" disabled>
        ...
        <div class="btn-group pull-right" style="margin: 13px;">
          ...
          <button class="btn btn-info  btnConfirmados"  title="Ver Pedidos CONFIRMADOS" disabled>
        ...
        <div class="btn-group pull-right" style="margin: 13px;">
          ...
          <button class="btn btn-default  btnAPT"  title="Ver Pedidos EN APT" disabled>
                  ...
                  <option value="">Seleccionar tipo de documento</option>
                    ...
                    <?php
                      ...
                      foreach ($documentos as $key => $value) {
                        if($value["codigo"] != '08' && $value["codigo"] != '85'){
