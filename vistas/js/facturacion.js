...
$(".tablaFacturas").on("click", ".btnImprimirFactura", function () {
    ...
    window.open(
        "extensiones/tcpdf/pdf/reporte_factura.php?tipo=" +
            tipo +
            "&documento=" +
            documento,
        "_blank"
...
$(".tablaBoletas").on("click", ".btnImprimirBoleta", function () {
    ...
    window.open(
        "extensiones/tcpdf/pdf/reporte_boleta.php?tipo=" +
            tipo +
            "&documento=" +
            documento,
        "_blank"
...
$(".tablaProcesarCE").on("click", "button.btnGenerarXMLCE", function () {
    ...
    if (tipo == "S03") {
        window.location =
            "index.php?ruta=procesar-ce&tipoFact=" +
            tipo +
            "&documentoFact=" +
            documento;
    } else if (tipo == "S02") {
        ...
        window.location =
            "index.php?ruta=procesar-ce&tipoNotaCred=" +
            tipo +
            "&documentoNotaCred=" +
            documento;
    } else if (tipo == "S99") {
        window.location =
            "index.php?ruta=procesar-ce&tipoNotaDeb=" +
            tipo +
            "&documentoNotaDeb=" +
            documento;
    } else {
        window.location =
            "index.php?ruta=procesar-ce&tipoGuia=" +
            tipo +
            "&documentoGuia=" +
            documento;
    }
...
$(".tablaFacturas, .tablaBoletas, .tablaProformas").on(
    ...
    function () {
        ...
        window.location =
            "index.php?ruta=crear-facturascv&tipo=" +
            tipo +
            "&documento=" +
            documento;
    }
 ...
 */
$(".tablaBoletas, .tablaFacturas").on(
    "click",
    ".btnImprimirTicketFacBol",
    function () {
        var tipo = $(this).attr("tipo");
        var documento = $(this).attr("documento");
        ...
        window.open(
            "vistas/reportes_ticket/fac_bol_ticket.php?tipo=" +
                tipo +
                "&documento=" +
                documento,
            "_blank"
