...
class TablaPedidosCV{
    ...
    public function mostrarTablaPedidosCV(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-primary btn-xs modificarArtSal' data-toggle='modal' data-target='#modalModificarClienteP' modelo='".$pedidos[$i]["modelo"]."'>Agregar</button></div>";
