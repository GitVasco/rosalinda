...
class ModeloArticulos
{
	...
	*/
	static public function mdlMostrarArticulosTaller($sectorIngreso){
		if($sectorIngreso=="T4" || $sectorIngreso=="T6" || $sectorIngreso=="T9" || $sectorIngreso=="T2" || $sectorIngreso=="T8" || $sectorIngreso=="T0" || $sectorIngreso=="TA" ||  $sectorIngreso=="T1" || $sectorIngreso == "T3"){
